...
function imageMessageReplies(img: string) {
  return <Image
    width={'220px'}
    borderRadius={'4px'}
    src={img} />
...
export default { dateDifferences, imageCircle, imageMessage, imageMessageReplies, editProfileCard, timeString, dateString }
